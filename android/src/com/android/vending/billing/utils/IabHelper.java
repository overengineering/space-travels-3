...
public class IabHelper
{
        ...
        this.mServiceConn = new ServiceConnection()
        {
            ...
            public void onServiceConnected(ComponentName name, IBinder service)
            {
                ...
                try
                {
                    ...
                    int response =
                        IabHelper.this.mService.isBillingSupported(3, packageName, ITEM_TYPE_INAPP);
                    ...
                    response =
                        IabHelper.this.mService.isBillingSupported(5, packageName, ITEM_TYPE_SUBS);
                    if (response == BILLING_RESPONSE_RESULT_OK)
                    {
                    ...
                    else
                    {
                        ...
                        response = IabHelper.this.mService.isBillingSupported(3,
                            packageName,
                            ITEM_TYPE_SUBS);
                        if (response == BILLING_RESPONSE_RESULT_OK)
                        {
    ...
    public void launchPurchaseFlow(
        Activity act, String sku, int requestCode,
     ...
     */
    public void launchPurchaseFlow(
        Activity act, String sku, String itemType, List<String> oldSkus,
        int requestCode, OnIabPurchaseFinishedListener listener, String extraData)
    {
        ...
        try
        {
            ...
            if (oldSkus == null || oldSkus.isEmpty())
            {
                ...
                buyIntentBundle = this.mService.getBuyIntent(3,
                    this.mContext.getPackageName(), sku, itemType,
                    extraData);
            }
            else
            {
                ...
                buyIntentBundle =
                    this.mService.getBuyIntentToReplaceSkus(5, this.mContext.getPackageName(),
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK)
        {
            ...
            if (this.mPurchaseListener != null)
            {
                this.mPurchaseListener.onIabPurchaseFinished(new IabResult(
                    BILLING_RESPONSE_RESULT_OK,
                    "Success"), purchase);
            }
        }
        ...
        else
        {
            ...
            result =
                new IabResult(IABHELPER_UNKNOWN_PURCHASE_RESPONSE, "Unknown purchase response.");
            if (this.mPurchaseListener != null)
            {
                this.mPurchaseListener.onIabPurchaseFinished(result, null);
            }
    ...
    public void queryInventoryAsync(
        final boolean querySkuDetails, final List<String> moreSkus,
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException
    {
        ...
        do
        {
            ...
            Bundle ownedItems = this.mService.getPurchases(3, this.mContext.getPackageName(),
        ...
        throws RemoteException, JSONException
    {
        ...
        for (ArrayList<String> skuPartList : packs)
        {
            ...
            Bundle skuDetails = this.mService.getSkuDetails(3, this.mContext.getPackageName(),
                itemType, querySkus);
